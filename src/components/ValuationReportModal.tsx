...
export function ValuationReportModal({
  ...
  const modal = (
    <div
      ...
      className="report-modal-backdrop fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 p-4 sm:p-6"
    >
      {/* Modal Container */}
      <div className="report-modal-content relative my-8 w-full max-w-4xl  bg-white shadow-2xl overflow-hidden text-[#10151f]">
        {/* Top Action Bar (Screen Only) */}
        <div className="no-print sticky top-0 z-10 flex items-center justify-between border-b border-[#e8dfc8]  px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={handlePrint}
              className="bg-gold-gradient inline-flex items-center gap-2  px-5 py-2 text-sm font-bold text-[#10151f] transition hover:opacity-90 shadow-sm"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className=" border border-[#e8dfc8] bg-white p-2 text-[#475569] hover:bg-[#f7f3ea] transition"
              aria-label="Close"
            >
              <X className="h-5 w-5" />
            </button>
        ...
        <div className="p-6 sm:p-10 space-y-8 bg-white">
          ...
          <div className="border-b-2 border-[#10151f] pb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="text-left sm:text-right border-l-2 sm:border-l-0 sm:border-r-2 border-[#d6a936] pl-3 sm:pl-0 sm:pr-3">
                <div className="inline-flex items-center gap-1.5  bg-[#fdf6dc] border border-[#e5c87a] px-3 py-1 text-xs font-bold text-[#8a5a00]">
          ...
          <div className=" border-2 border-[#10151f] bg-[#fffdf8] p-6 shadow-sm">
          ...
          <div>
            ...
            <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-4  bg-[#f7f3ea] p-4 text-xs">
              <div>
              ...
              <table className="w-full text-xs text-left border border-[#e8dfc8]">
                <thead className="bg-[#f8f1e3] text-[#10151f] font-semibold border-b border-[#e8dfc8]">
                  <tr>
                    ...
                    <th className="p-2.5 border-r border-[#e8dfc8]">
                      Category
                    </th>
                    <th className="p-2.5 border-r border-[#e8dfc8] text-right">
                      Rate / Aana
                    </th>
                    <th className="p-2.5 border-r border-[#e8dfc8] text-center">
                      Weight
                    </th>
                ...
                <tbody className="divide-y divide-[#e8dfc8]">
                  <tr>
                    ...
                    <td className="p-2.5 border-r border-[#e8dfc8] font-medium">
                      Government Valuation Rate
                    </td>
                    <td className="p-2.5 border-r border-[#e8dfc8] text-right">
                      {formatNPR(result.land.inputs.governmentRate)}
                    </td>
                    <td className="p-2.5 border-r border-[#e8dfc8] text-center">
                ...
                <tfoot className="bg-[#fffdf8] font-bold border-t-2 border-[#10151f]">
                  <tr>
                    <td colSpan={2} className="p-2.5 border-r border-[#e8dfc8]">
                      Adopted Land Rate
                    </td>
                    <td
                      colSpan={3}
                      className="p-2.5 text-right text-sm text-[#10151f]"
                    >
                  ...
                  <tr className="bg-[#f7f3ea]">
                    ...
                    <td
                      colSpan={3}
                      className="p-2.5 text-right text-base text-[#10151f]"
                    >
                      {formatNPR(result.land.landValue)}
                    </td>
                  </tr>
          ...
          <div>
            <h2 className="font-serif text-lg font-bold text-[#10151f] flex items-center gap-2 border-b border-[#e8dfc8] pb-2">
              <LandPlot className="h-4 w-4 text-[#8a5a00]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              <div className=" border border-[#e8dfc8] bg-[#fffdf8] p-4">
                <span className="block text-[11px] font-bold uppercase tracking-wide text-[#64748b]">
                  Amenity Score
                </span>

                <div className="mt-1 flex items-end gap-1">
                  <span className="font-serif text-2xl font-bold text-[#10151f]">
              ...
              <div className=" border border-[#e8dfc8] bg-[#fffdf8] p-4">
                ...
                <span
                  className={`mt-1 block font-serif text-2xl font-bold ${
              ...
              <div className=" border border-[#e8dfc8] bg-[#fffdf8] p-4">
                ...
                <span className="mt-1 block font-serif text-xl font-bold text-[#10151f]">
                  {formatNPR(result.land.inputs.marketRate)}
            ...
            {/* Amenity details */}
            <div className="overflow-hidden  border border-[#e8dfc8]">
            ...
            <div className="mt-3  bg-[#f7f3ea] px-3 py-2.5 text-[11px] leading-relaxed text-[#475569]">
  ...
  <div className="mt-8 print:mt-6">
    ...
    <div className="mb-4 flex items-end justify-between border-b-2 border-[#10151f] pb-2">
      <div>
        <h2 className="flex items-center gap-2 font-serif text-xl font-bold text-[#10151f]">
          <Image className="h-5 w-5 text-[#8a5a00]" />
          Property Images
        </h2>
    ...
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 print:grid-cols-2">
      {property.images.map((img, idx) => (
        <div
          key={`${img.type}-${idx}`}
          className="overflow-hidden  border border-[#d9d0bc] bg-white print:break-inside-avoid"
        >
          {/* Image Header */}
          <div className="flex items-center justify-between border-b border-[#e8dfc8] bg-[#faf8f2] px-3 py-2">
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-[#8a5a00]">
                {img.name}
              </p>
            ...
            <span className="flex h-6 w-6 items-center justify-center  bg-[#10151f] text-[10px] font-semibold text-white">
              {String(idx + 1).padStart(2, "0")}
            </span>
          </div>

          {/* Image */}
          <div className="relative h-70 w-full bg-gray-100 print:h-52">
            <img
          ...
          {buildingResult ? (
            <div>
                ...
                <table className="w-full text-xs text-left border border-[#e8dfc8] mb-4">
                  ...
                  <tbody className="divide-y divide-[#e8dfc8]">
                    {buildingResult.floors.map((floor, idx) => (
                      <tr key={idx}>
                        <td className="p-2.5 border-r border-[#e8dfc8]">
                          {idx + 1}
                        </td>
                        <td className="p-2.5 border-r border-[#e8dfc8] font-medium">
                          {floor.floor}
                  ...
                  <tfoot className="bg-[#fffdf8] font-semibold border-t border-[#e8dfc8]">
                    <tr>
                      <td
                        colSpan={2}
                        className="p-2.5 border-r border-[#e8dfc8]"
                      >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-[#f7f3ea] p-4  text-xs">
                <div>
              ...
              <div className="mt-4 border border-[#e8dfc8]  p-4 bg-[#fffdf8]">
                <h3 className="font-semibold text-xs text-[#10151f] mb-2 uppercase tracking-wide">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs">
                  ...
                  <div className="col-span-2 sm:col-span-1 bg-[#f8f1e3] p-2 -right">
            ...
            <div className=" border border-dashed border-[#e8dfc8] p-4 text-xs text-[#475569]">
          ...
          <div>
            ...
            <div className="mt-3 grid grid-cols-3 gap-3 text-center text-xs">
              <div className=" border border-[#fecaca] bg-[#fef2f2] p-3">
              ...
              <div className=" border border-[#e5c87a] bg-[#fdf6dc] p-3">
                <span className="block text-[#8a5a00] font-semibold">
                  Expected (70%)
                </span>
                <span className="font-serif font-bold text-sm text-[#10151f] mt-1 block">
          ...
          <div className="pt-6 border-t-2 border-[#10151f]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-xs text-[#10151f]">
              ...
              <div className="col-span-2 sm:col-span-1 flex flex-col justify-end items-center sm:items-end">
                <div className="h-20 w-20 border-2 border-dashed border-[#d6a936]  flex items-center justify-center text-[10px] text-[#8a5a00] font-bold text-center p-2">
...
function AmenityReportItem({
  ...
  return (
    <div className="border-b border-r border-[#e8dfc8] p-3">
      <div className="flex items-center gap-2">
